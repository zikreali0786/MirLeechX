...
class GDTOT:
      def __init__(self, url_):
          ...
          self.rq_data = rq.get(url_, headers=self.h, cookies=self.c).text
      ...
      def get_filename(self):
          """Get file name from gdtot link"""
          try:
              soup = bt(self.rq_data, "html.parser").find("h5").text
              return soup
          except:
              return
